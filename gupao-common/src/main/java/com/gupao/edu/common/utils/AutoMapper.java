...
public class AutoMapper {
     ...
     * </pre>
     */
    public static <T> List<T> batchTransform(final Class<T> clazz, List<?> srcList) throws Exception {
     ...
     * </pre>
     */
    public static <T> T transform(Class<T> clazz, Object src) throws Exception {
        if (src == null) {
            return null;
        }
        T instance;
    ...
    public static <K, V> Map<K, V> mapByKey(String key, List<?> list) throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <K, V> Map<K, List<V>> aggByKeyToList(String key, List<?> list) throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <K> Set<K> toPropertySet(String key, List<?> list) throws Exception {
    ...
    private static final String[] COPY_IGNORED_PROPERTIES = {"id", "createUserId", "createTime", "updateUserId","updateTime"};
}
